export const translations = {
  en: {
    ...
    email: {
      subject: "Your Cybersecurity Assessment Report",
      greeting: "Dear",
      body: "Thank you for completing the Cybersecurity Self-Assessment. Please find your detailed assessment report attached to this email.",
    ...
    assessmentGuidance: {
      ...
      points: {
        eight: {
          label: "Advanced/Mature",
          description: "Fully integrated, continuous, and aligned with industry frameworks"
        },
        five: {
          label: "Moderate",
          description: "Defined and reviewed periodically at a senior level"
        },
        three: {
          label: "Basic",
          description: "Performed ad-hoc or inconsistently"
        },
        zero: {
          label: "Not in place",
